    ...
    res.send(`
        ...
        <body>
            <div class="container">
                ...
                <div class="status">
                    ✅ 服务器运行中 | 端口: ${PORT} | 版本: 2.1 | 包含横幅管理功能
                </div>
                ...
                <div class="new-feature">
                    ...
                    <ul>
                        ...
                        <li>✅ <code>POST /api/settings/banner/update</code> - 更新横幅（通过URL）</li>
                        <li>✅ <code>DELETE /api/settings/banner</code> - 删除横幅</li>
                        <li>✅ 支持图片URL链接，无需文件上传</li>
                        <li>✅ 自动保存横幅信息到数据库</li>
                    </ul>
                ...
                <div class="section">
                    ...
                    <div style="background: #f0f2f5; padding: 15px; border-radius: 8px;">
                        ...
                        <div style="margin-bottom: 8px;"><span class="method post">POST</span> <span class="url">/api/settings/banner/update</span> - 更新横幅（URL方式）</div>
                ...
                <div class="note">
                    ...
                    3. 支持图片URL链接方式管理横幅<br>
                    4. 支持多用户同时访问<br>
                    5. <strong>版本2.1新增功能：</strong> 
                       <ul>
                           <li>✅ 商城顶部横幅图片管理</li>
                           <li>✅ 通过URL链接方式管理横幅</li>
                           <li>✅ 简单易用的横幅管理API</li>
                ...
                <div style="text-align: center; margin-top: 30px; color: #666; font-size: 12px;">
                    ©2025 YP俱乐部 | 数据文件自动保存 | 实时同步 | 版本2.1
                </div>
            </div>
        </body>
        </html>
...
app.use((req, res) => {
    res.status(404).json({
        ...
        availableEndpoints: [
            ...
            'POST /api/settings/banner/update (更新横幅)',
