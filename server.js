...
app.post('/api/settings/banner', async (req, res) => {
    try {
        ...
        if (bannerData.dataUrl && bannerData.dataUrl.startsWith('data:image/')) {
            ...
            // 文件信息（来自前端预览）
            console.log('📷 处理文件信息:', bannerData.file);
            
            data.banner = {
                type: 'url',
                url: bannerData.file.dataUrl || bannerData.file.url || '',
...
app.put('/api/settings/banner/toggle', async (req, res) => {
    try {
        ...
        console.log(`✅ 横幅状态已更新: ${enabled ? '启用' : '禁用'}`);
        
        res.json({
            success: true,
            data: data.banner,
            message: `横幅已${enabled ? '启用' : '禁用'}`
        });
    } catch (error) {
...
app.get('/api/system-config', async (req, res) => {
    try {
        ...
        const config = {
            ...
            banner: data.banner,
            services: data.services.filter(service => service.enabled !== false),
            stats: {
            ...
            <div class="container">
                ...
                <div class="new-feature">
                    ...
                    <ul>
                        ...
                        <li>✅ <code>POST /api/settings/banner</code> - 上传横幅图片（新增！）</li>
                        <li>✅ <code>POST /api/settings/banner/update</code> - 更新横幅信息</li>
                        <li>✅ <code>PUT /api/settings/banner/toggle</code> - 切换横幅状态</li>
                        <li>✅ <code>DELETE /api/settings/banner</code> - 删除横幅图片</li>
                    </ul>
                    <p><strong>已修复的问题：</strong></p>
                    <ul>
                        <li>✅ 修复了POST接口无法接收横幅数据的问题</li>
                        <li>✅ 支持base64、URL链接和文件信息多种格式</li>
                        <li>✅ 添加了更详细的日志记录</li>
                    </ul>
                </div>
                ...
                <div class="section">
                    ...
                    <div style="margin-bottom: 15px;">
                        <a href="/data.json" target="_blank">📄 查看数据文件 (data.json)</a> | 
                        <a href="/api/test" target="_blank">🧪 测试API连接</a> | 
                ...
                <div class="section">
                    ...
                    <div class="api-list">
                        ...
                        <div class="api-item">
                            ...
                            <span class="url">/api/products/add</span>
                            <p>添加新商品</p>
                        </div>
                        <div class="api-item">
                            <span class="method post">POST</span>
                            <span class="url">/api/products/delete</span>
                            <p>删除商品</p>
                        </div>
                        <div class="api-item">
                            <span class="method post">POST</span>
                            <span class="url">/api/products/sync</span>
                            <p>批量同步商品</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="api-list">
                        ...
                        <div class="api-item">
                            <span class="method post">POST</span>
                            <span class="url">/api/orders/add</span>
                            <p>添加新订单（包含游戏信息）</p>
                        </div>
                        <div class="api-item">
                        ...
                        <div class="api-item">
                            ...
                            <span class="url">/api/orders/:id/status</span>
                            <p>更新订单状态</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="api-list">
                        <div class="api-item">
                            <span class="method get">GET</span>
                            <span class="url">/api/settings</span>
                            <p>获取系统设置</p>
                        </div>
                        <div class="api-item">
                            <span class="method post">POST</span>
                            <span class="url">/api/settings/update</span>
                            <p>更新系统设置</p>
                        </div>
                        <div class="api-item">
                            <span class="method get">GET</span>
                        ...
                        <div class="api-item">
                            <span class="method get">GET</span>
                            <span class="url">/api/system-config</span>
                            <p>获取完整系统配置（含横幅）</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="note">
                    <h3>📝 使用说明</h3>
                    <p>1. <strong>默认管理员账号:</strong> admin / admin123</p>
                    <p>2. <strong>数据存储:</strong> 所有数据保存在根目录的 <code>data.json</code> 文件中</p>
                    <p>3. <strong>CORS支持:</strong> 已启用跨域资源共享，支持前后端分离部署</p>
                    <p>4. <strong>游戏信息字段:</strong> 订单API已包含游戏名称、游戏区服等字段</p>
                    <p>5. <strong>横幅管理:</strong> 支持上传、更新、删除商城顶部横幅图片</p>
                    <p>6. <strong>启动命令:</strong> <code>node server.js</code> 或 <code>npm start</code></p>
                </div>
            </div>
        </body>
        </html>
