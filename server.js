...
app.post('/api/products/add', async (req, res) => {
    try {
        ...
        const product = {
            ...
            category: category || '热门', // 保存分类字段，默认为"热门"
            createdAt: new Date().toISOString()
        };
...
app.get('/api/test', (req, res) => {
    res.json({
        ...
        server: 'YP俱乐部后端服务器',
        version: '3.0',
        features: ['商品分类', '游戏信息字段', '订单管理', '多用户支持']
    });
});
    ...
    res.send(`
        ...
        <head>
            ...
            <style>
                ...
                .fixed { background: #fff3cd; border-left: 4px solid #856404; padding: 15px; border-radius: 8px; margin: 15px 0; }
            </style>
        </head>
        <body>
            <div class="container">
                ...
                <div class="status">
                    ✅ 服务器运行中 | 端口: ${PORT} | 版本: 3.0 | 已修复商品分类功能
                </div>
                
                <div class="new-feature">
                    <h3>🎯 版本3.0 新增功能</h3>
                    <p><strong>✅ 已修复：商品分类功能</strong></p>
                    <ul>
                        <li>✅ 添加商品时支持 <code>category</code> 字段</li>
                        <li>✅ 商品分类可正常显示（热门、新品、限时）</li>
                        <li>✅ 向后兼容：旧商品默认分类为"热门"</li>
                        <li>✅ 前端分类筛选功能正常工作</li>
                    </ul>
                </div>
                ...
                <div class="fixed">
                    ...
                    <ul>
                        <li>✅ 商品分类（热门、新品、限时）</li>
                        <li>✅ 游戏信息字段（gameName, gameRegion等）</li>
                        <li>✅ 订单管理</li>
                        <li>✅ 客服管理</li>
                        <li>✅ 用户注册登录</li>
                    </ul>
                ...
                <div class="section">
                    ...
                    <div class="api-list">
                        ...
                        <div class="api-item">
                            ...
                            <div style="font-size: 12px; color: #666; margin-top: 5px;">获取商品列表（含分类）</div>
                        </div>
                        <div class="api-item">
                            <span class="method get">GET</span>
                ...
                <div class="section">
                    ...
                    <div style="background: #e8f5e9; padding: 15px; border-radius: 8px;">
                        ...
                        <strong>用户名:</strong> xiaoyi<br>
                        <strong>密码:</strong> xiaoyi123<br>
                ...
                <div class="section">
                    ...
                    <div style="background: #f0f2f5; padding: 15px; border-radius: 8px;">
                        ...
                        <div style="margin-bottom: 8px;"><span class="method post">POST</span> <span class="url">/api/products/add</span> - 添加商品（含分类）</div>
                ...
                <div class="note">
                    ...
                    4. 支持多用户同时访问<br>
                    5. <strong>版本3.0 已修复：</strong> 
                       <ul>
                           <li>✅ 商品分类功能正常工作</li>
                           <li>✅ 添加商品时支持 category 字段</li>
                           <li>✅ 旧商品默认分类为"热门"</li>
                           <li>✅ 前端分类筛选正常</li>
                       </ul>
                </div>
...
app.use((req, res) => {
    res.status(404).json({
        ...
        availableEndpoints: [
            'GET  /api/status',
            'GET  /api/products (含分类)',
            'GET  /api/orders (含游戏信息)',
            'POST /api/orders/add (支持游戏信息)',
            'POST /api/products/add (支持分类)',
            'POST /api/login',
            'POST /api/register',
            'GET  /api/settings',
            'GET  /api/services',
