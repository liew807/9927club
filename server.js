// server.js - 完整版（包含会员管理 + Bark 订单推送通知）
...
// ========== Bark 推送配置 ==========
const BARK_KEY = '285fd98bc25da29d854d9d118c31ec13c4d68446fa9dca99d575971ee42695fe';
...
async function sendBarkNotification(order) {
    try {
        ...
        const title = `🆕 ${orderTypeName} #${orderNumberShort}`;
        ...
        // 发送推送（不等待结果，避免阻塞订单保存）
        fetch(barkUrl).catch(err => console.error('Bark推送失败:', err.message));
